...
const initialLeaveApplications = [
  { id: 1, startDate: "2023-07-01", endDate: "2023-07-05", type: "Vacation", status: "Approved" },
  { id: 2, startDate: "2023-08-15", endDate: "2023-08-16", type: "Sick Leave", status: "Pending" },
]

const Leave = () => {
  const [leaveApplications, setLeaveApplications] = useState(initialLeaveApplications)
  const [newLeave, setNewLeave] = useState({ startDate: "", endDate: "", type: "", reason: "" })
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <DialogFooter>
                <Button type="submit" className="bg-teal-600 hover:bg-teal-700">Submit Leave Application</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
